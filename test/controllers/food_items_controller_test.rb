...
class FoodItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post food_items_url, params: { food_item: { description: @food_item.description, img: @food_item.img, name: @food_item.name, price: @food_item.price, section_id: @food_item.section_id } }
    end
  ...
  test "should update food_item" do
    patch food_item_url(@food_item), params: { food_item: { description: @food_item.description, img: @food_item.img, name: @food_item.name, price: @food_item.price, section_id: @food_item.section_id } }
